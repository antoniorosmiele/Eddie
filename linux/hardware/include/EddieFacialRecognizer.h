...
#ifndef EDDIE_EDDIEFacialRecognizer_H
#define EDDIE_EDDIEFacialRecognizer_H

#include "eddie.h"
#include <json/json.h>
#include <thread>

class EddieFacialRecognizer : public EddieResource {
private:
    char *path;
    char *attributes;
...
public:
    explicit EddieFacialRecognizer(const std::string &path,
                               const std::string &attributes,
                               Json::Value root,
                               bool on_board);

    ~EddieFacialRecognizer();
