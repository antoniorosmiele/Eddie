...
#ifndef EDDIE_EDDIEMattressCover_H
#define EDDIE_EDDIEMattressCover_H

#include "eddie.h"
#include <json/json.h>
#include <thread>

class EddieMattressCover : public EddieResource {
private:
    char *path;
    char *attributes;
...
public:
    explicit EddieMattressCover(const std::string &path,
