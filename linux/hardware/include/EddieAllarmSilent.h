...
#ifndef EDDIE_EDDIEAllarmSilent_H
#define EDDIE_EDDIEAllarmSilent_H

#include "eddie.h"
#include <json/json.h>
#include <thread>

class EddieAllarmSilent : public EddieResource {
private:
    char *path;
    char *attributes;
...
public:
    explicit EddieAllarmSilent(const std::string &path,
