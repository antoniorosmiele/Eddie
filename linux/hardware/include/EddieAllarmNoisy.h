...
#ifndef EDDIE_EDDIEAllarmNoisy_H
#define EDDIE_EDDIEAllarmNoisy_H

#include "eddie.h"
#include <json/json.h>
#include <thread>

class EddieAllarmNoisy : public EddieResource {
private:
    char *path;
    char *attributes;
...
public:
    explicit EddieAllarmNoisy(const std::string &path,
