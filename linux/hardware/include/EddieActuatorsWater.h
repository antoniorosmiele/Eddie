...
#ifndef EDDIE_EDDIEActuatorsWater_H
#define EDDIE_EDDIEActuatorsWater_H

#include "eddie.h"
#include <json/json.h>
#include <thread>

class EddieActuatorsWater : public EddieResource {
private:
    char *path;
    char *attributes;
...
public:
    explicit EddieActuatorsWater(const std::string &path,
