...
EddieFacialRecognizer::EddieFacialRecognizer(const std::string &path,
    ...
    std::string attributest = "rt=" + root["rt"].asString() + "&id=" + root["id"].asString() + "&accuracy=" + root["accuracy"].asString();
...
EddieFacialRecognizer::~EddieFacialRecognizer() {
    delete[] path;
    delete[] attributes;
}

message_t EddieFacialRecognizer::render_get(request_t &request) {
    message_t response;
...
message_t EddieFacialRecognizer::render_post(request_t &request) {
    message_t response;
...
message_t EddieFacialRecognizer::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieFacialRecognizer::get_path() {
    return &split_path[0];
}

const char *const *EddieFacialRecognizer::get_attributes() {
