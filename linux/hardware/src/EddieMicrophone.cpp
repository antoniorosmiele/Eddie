...
EddieMicrophone::EddieMicrophone(const std::string &path,
...
EddieMicrophone::~EddieMicrophone() {
    delete[] path;
    delete[] attributes;
}

message_t EddieMicrophone::render_get(request_t &request) {
    message_t response;
...
message_t EddieMicrophone::render_post(request_t &request) {
    message_t response;
...
message_t EddieMicrophone::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieMicrophone::get_path() {
    return &split_path[0];
}

const char *const *EddieMicrophone::get_attributes() {
