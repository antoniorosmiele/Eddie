...
EddieTent::EddieTent(const std::string &path,
...
message_t EddieTent::render_get(request_t &request) {
    message_t response;
...
message_t EddieTent::render_post(request_t &request) {
    message_t response;
...
message_t EddieTent::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieTent::get_path() {
    return &split_path[0];
}

const char *const *EddieTent::get_attributes() {
