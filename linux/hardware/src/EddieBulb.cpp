...
EddieBulb::EddieBulb(const std::string &path,
...
message_t EddieBulb::render_get(request_t &request) {
    message_t response;
...
message_t EddieBulb::render_post(request_t &request) {
    message_t response;
...
message_t EddieBulb::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieBulb::get_path() {
    return &split_path[0];
}

const char *const *EddieBulb::get_attributes() {
