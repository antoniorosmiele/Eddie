...
EddieAudioSpeaker::EddieAudioSpeaker(const std::string &path,
    ...
    std::string attributest = "rt=" + root["rt"].asString() + "&id=" + root["id"].asString() + "&place=" + root["place"].asString() + "&connectedTo=" + root["connectedTo"].asString();
...
EddieAudioSpeaker::~EddieAudioSpeaker() {
    delete[] path;
    delete[] attributes;
}

message_t EddieAudioSpeaker::render_get(request_t &request) {
    message_t response;
...
message_t EddieAudioSpeaker::render_post(request_t &request) {
    message_t response;
...
message_t EddieAudioSpeaker::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieAudioSpeaker::get_path() {
    return &split_path[0];
}

const char *const *EddieAudioSpeaker::get_attributes() {
