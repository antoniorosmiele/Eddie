...
EddieVibrationAllarm::EddieVibrationAllarm(const std::string &path,
    ...
    std::string attributest = "rt=" + root["rt"].asString() + "&id=" + root["id"].asString() + "&ConnectedTo=" + root["ConnectedTo"].asString();
...
EddieVibrationAllarm::~EddieVibrationAllarm() {
    delete[] path;
    delete[] attributes;
}

message_t EddieVibrationAllarm::render_get(request_t &request) {
    message_t response;
...
message_t EddieVibrationAllarm::render_post(request_t &request) {
    message_t response;
...
message_t EddieVibrationAllarm::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieVibrationAllarm::get_path() {
    return &split_path[0];
}

const char *const *EddieVibrationAllarm::get_attributes() {
