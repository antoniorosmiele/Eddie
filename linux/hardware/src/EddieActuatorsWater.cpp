...
EddieActuatorsWater::EddieActuatorsWater(const std::string &path,
...
EddieActuatorsWater::~EddieActuatorsWater() {
    delete[] path;
    delete[] attributes;
}

message_t EddieActuatorsWater::render_get(request_t &request) {
    message_t response;
...
message_t EddieActuatorsWater::render_post(request_t &request) {
    message_t response;
...
message_t EddieActuatorsWater::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieActuatorsWater::get_path() {
    return &split_path[0];
}

const char *const *EddieActuatorsWater::get_attributes() {
