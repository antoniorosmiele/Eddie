...
EddieAllarmNoisy::EddieAllarmNoisy(const std::string &path,
...
EddieAllarmNoisy::~EddieAllarmNoisy() {
    delete[] path;
    delete[] attributes;
}

message_t EddieAllarmNoisy::render_get(request_t &request) {
    message_t response;
...
message_t EddieAllarmNoisy::render_post(request_t &request) {
    message_t response;
...
message_t EddieAllarmNoisy::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieAllarmNoisy::get_path() {
    return &split_path[0];
}

const char *const *EddieAllarmNoisy::get_attributes() {
