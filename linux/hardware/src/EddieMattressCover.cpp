...
EddieMattressCover::EddieMattressCover(const std::string &path,
    ...
    std::string attributest = "rt=" + root["rt"].asString() + "&id=" + root["id"].asString() + "&place=" + root["place"].asString() + "&owner=" + root["owner"].asString();
...
EddieMattressCover::~EddieMattressCover() {
    delete[] path;
    delete[] attributes;
}

message_t EddieMattressCover::render_get(request_t &request) {
    message_t response;
...
message_t EddieMattressCover::render_post(request_t &request) {
    message_t response;
...
message_t EddieMattressCover::render_put(request_t &request) {
    return render_post(request);
}

const char *const *EddieMattressCover::get_path() {
    return &split_path[0];
}

const char *const *EddieMattressCover::get_attributes() {
